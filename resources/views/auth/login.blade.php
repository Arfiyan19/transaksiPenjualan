...
<head>
    ...
    <title>Login &mdash; Sistem Transaksi Penjualan</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h5 class="text-dark font-weight-normal">Perhitungan <span class="font-weight-bold">Sistem Transaksi</span></h5>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Sistem Transaksi
                        </div>
                    </div>
                </div>
